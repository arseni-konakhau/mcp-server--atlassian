...
echo "2. Run the simple test: uv run python ./scripts/_simple_test.py --verbose"
echo "3. Run using HTTP Transport: uv run mcp-atlassian --transport streamable-http --port 3334 --env-file .env --verbose"
echo "4. Validate using REST Client: ./_http/validate.http"
